...
function Homepage(){
    ...
    <div className="landing-page-bg">
        ...
        <nav className="background-default fixed w-full z-20 top-0 start-0 border-b">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://theripplegym.vercel.app/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <span className="ripple-title-logo self-center text-2xl font-semibold whitespace-nowrap dark:text-white">RIPPLE</span>
        </a>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <button type="button" className="btn-primary text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">Login</button>
