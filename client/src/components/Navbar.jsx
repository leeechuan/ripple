    ...
    <div className="navbar">
            ...
            <div className="background-default px-3 py-3 lg:px-5 lg:pl-3">
                ...
                <div className="flex items-center justify-start rtl:justify-end">
                    <button onClick={toggleSidebarVisibility} type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
            ...
            {!isMobileView || isSidebarVisible ? (
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="/workout"  className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                        ...
                        <li>
                            <a href="/userdetail" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
