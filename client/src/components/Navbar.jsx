            ...
            {!isMobileView || isSidebarVisible ? (
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a onClick={() => navigate("/workoutarchive")}  className="cursor-pointer flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Workout Archive</span>
                        ...
                        <li>
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Promotions</span>
                        ...
                        <li>
                            <a onClick={() => navigate("/products")} href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Merchandise</span>
                            </a>
                        </li>
                        <li>
