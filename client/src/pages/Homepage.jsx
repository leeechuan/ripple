...
function Homepage(){
    ...
    useEffect(() => {
        ...
        setModalOpen(false);
        }, 500000); // Close modal after 5 seconds
    ...
    <div>
        ...
        <div className="background-default">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" onClick={()=> {setGoToLogin(true)}}  className="btn-primary text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center ">Login</button>
                <button onClick={()=> {alert("clicked")}} data-collapse-toggle="navbar-sticky" type="button" className="z-50 inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false" id="navbar-hamburger">
