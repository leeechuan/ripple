    ...
    <div className="login-page">
        ...
        <div className="bg-default-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                ...
                <button disabled = {isLoading} type="submit" className="w-full btn-primary text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign up</button>
